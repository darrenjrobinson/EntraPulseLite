...
git commit -m "feat: Update version from v1.0.0 to v1.0.1" -m "Update package.json version field" -m "Update src/shared/version.ts VERSION constant" -m "Update all fallback version references in code" -m "Update MCP client version fields" -m "Update test files with new version" -m "Update package-lock.json" -m "This marks the patch release v1.0.1"
...
Write-Host "Version v1.0.1 is now ready" -ForegroundColor Cyan
